...
public class Banner extends FrameLayout implements View.OnClickListener {
    ...
    private void initLayout() {
        ...
        View view = LayoutInflater
                .from(context)
                .inflate(R.layout.banner_top, this, true);
    ...
    private void initImgFromRes(int[] imagesRes) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                    ...
                    LinearLayout.LayoutParams.WRAP_CONTENT);
            params.leftMargin = DensityUtil.dp2px(context, 4);
            params.rightMargin = DensityUtil.dp2px(context, 4);
            iv_dot.setImageDrawable(getResources().getDrawable(R.drawable.dot_grey));
            ll_dot.addView(iv_dot, params);
            iv_dots.add(iv_dot);
        }
        iv_dots.get(0).setImageDrawable(getResources().getDrawable(R.drawable.dot_orange));
...
//            iv.setBackgroundResource(R.mipmap.loading);
    ...
    class MyOnPageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            for (int i = 0; i < iv_dots.size(); i++) {
                if (i == arg0 - 1) {
                    iv_dots.get(i).setImageDrawable(getResources().getDrawable(R.drawable.dot_orange));
                } else {
                    iv_dots.get(i).setImageDrawable(getResources().getDrawable(R.drawable.dot_grey));
                }
            }
        }
    }
    ...
    public interface OnItemClickListener {
        void onItemClick(View v, int currentItem);
    }
